...
export function Book() {
    ...
    return (
        <>
            ...
            <button type='submit' onClick={() => navigate('/create')} className='btn btn-success '>Add a new Book
            </button>
                        ...
                        <tr key={books.id}>
                            ...
                            <td>
                                ...
                                <button style={{marginLeft: "10px"}} type="button" className="btn btn-danger"
                                        ...
                                        onClick={() => prop(books.id, books.title)}>
                                    Delete
                                </button>
                    ...
                    <div className="modal-content">
                        ...
                        <div className="modal-footer">
                            ...
                            <button type="button" className="btn btn-primary"
                                    onClick={() => handleDelete(idDelete)}>Save changes
                            </button>
                        </div>
                    </div>
                </div>
